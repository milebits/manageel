...
class CreatePackagesTable extends Migration
{
    public function up()
    {
        Schema::create('packages', function (Blueprint $table) {
            ...
            $table->bigInteger('monthly_bandwidth')->default(ManageEL::gigaBytes(100));
            $table->bigInteger('max_ftp_accounts')->default(1);
            $table->bigInteger('max_email_accounts')->default(1);
            $table->bigInteger('max_quota_per_email')->default(ManageEL::megaBytes());
            $table->bigInteger('max_email_list')->default(0);
            $table->bigInteger('max_databases')->default(1);
            ...
            $table->bigInteger('max_hourly_relayed_emails_per_domain')->default(100);
